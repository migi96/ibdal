...
/* Concentric shader rings that bloom outward, adapted to TypeScript + a Next.js
   client component. Self-pauses when scrolled offscreen or the tab is hidden. */
...
export default function MagicRings({
  ...
  const propsRef = useRef({
    ...
    ringGap, fadeIn, fadeOut, followMouse, mouseInfluence, hoverScale,
    parallax, clickBurst,
  });
